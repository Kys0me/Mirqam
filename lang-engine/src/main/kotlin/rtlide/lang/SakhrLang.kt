...
object SakhrLang {
    ...
    fun definition(): LanguageDefinition = LanguageDefinition(
        ...
        grammar = Grammar(
            keywords = listOf("إجراء", "ليكن", "ألزم", "إذن", "السياق", "ابدأ", "انتهى"),
            controlKeywords = listOf("إن كان", "وإلا", "رجع"),
            builtins = listOf("أكتب", "إنهاء_البرنامج", "نص", "طول", "حجم", "رقم", "منطقي", "قائمة", "خذ", "المطلع"),
    ...
    val SAMPLE_CODE: String = """
        // برنامج تجريبي بلغة صخر
        إجراء ترحيب(الاسم) ابدأ
            أكتب("مرحباً " + الاسم)
        انتهى

        ليكن العمر = ٢٥
        إن كان العمر > ١٨ ابدأ
            ترحيب("أحمد")
        وإلا ابدأ
            أكتب("عذراً، أنت صغير جداً")
        انتهى
    """.trimIndent()
}
