...
object SakhrLang {
    ...
    fun definition(): LanguageDefinition = LanguageDefinition(
        ...
        grammar = Grammar(
            keywords = listOf("إجراء", "ليكن", "ألزم", "إذن", "السياق", "ابدأ", "انتهى", "كرر", "في", "اكفف", "امض", "بلغ", "بنية", "تعداد", "دالة", "و", "أو", "ليس"),
            controlKeywords = listOf("إن كان", "وإلا", "رد", "ما دام", "لكل", "طابق", "استجلب", "من", "الأم"),
            builtins = listOf("أكتب", "إنهاء_البرنامج", "كنص", "طول", "حجم", "رقم", "منطقي", "قائمة", "خذ", "المطلع", "اقرأ", "أضف", "أزل", "أدخل", "فهرس", "استبدل"),
            constants = listOf("صح", "خطأ", "فارغ", "عدم"),
